...
Here we see much more differentiation, as the area most closest to the Pacific Ocean at Imperial Beach shows the least amount of variability, given the regulation of temperature that the massive body of water provides. Compare this to the variation at Lemon Grove, near the mountains further inland.
...
Here again we see the influence of proximity to the water.  The areas at Imperial Beach and northwest of Coronado both have minimum humidities of over 85%.  Meanwhile, the inland Lemon Grove area had a mimimum 20% lower.

The plotWeather function also provides the ability to see a traditional line graph of conditions across time, rather than just a singular aggregate value. The following funcion call will look just at the average temperatue.  This can be used in combination with the original map plot of PWSs.
